...
bk_1850_doubt <- read_csv('/Users/prajwal/Desktop/Columbia/C4SR/mn_1850/combine-not so confident.csv')

col1 <- sapply(toupper(bk_1850_doubt$`Full Address`), clean)
col2 <- sapply(toupper(bk_1850_doubt$`H House Number`), clean)
col3 <- sapply(toupper(bk_1850_doubt$`H Street Name`), clean)
col4 <- sapply(toupper(bk_1850_doubt$c_street1), clean)
col5 <- sapply(toupper(bk_1850_doubt$c_street2), clean)
col6 <- sapply(toupper(bk_1850_doubt$n_street1), clean)
col7 <- sapply(toupper(bk_1850_doubt$n_street2), clean)
col8 <- sapply(toupper(bk_1850_doubt$`new h city`), clean)
col9 <- sapply(toupper(bk_1850_doubt$`new h house number`), clean)
col10 <- sapply(toupper(bk_1850_doubt$`new h street name`), clean)


bk_1850_doubt_after_cleaning <- data.frame(col1,col2,col3,col4,col5,col6,col7,col8,col9,col10)
write.csv(bk_1850_doubt_after_cleaning, '/Users/prajwal/Desktop/Columbia/C4SR/mn_1850/after cleaning/mn_1850_after_cleaning_not_so_confident.csv')
